...
public class ShopingListActivity extends AppCompatActivity
    ...
    public void onAddItemSelected(){
        ...
        Fragment selectedFragment = new AddNewItemFragment();
    ...
    public void restoreActionBar() {
        ...
        actionBar.setBackgroundDrawable(new ColorDrawable(Color.parseColor("#3F6E32")));
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        if (!mNavigationDrawerFragment.isDrawerOpen()) {
            ...
            getMenuInflater().inflate(R.menu.shoping_list, menu);
            restoreActionBar();
            return true;
        }
    ...
    public static class PlaceholderFragment extends Fragment {
        ...
        public void onAttach(Activity activity) {
            ...
            ((ShopingListActivity) activity).onSectionAttached(
